        ...
        Surface(
           ...
           Column(modifier = Modifier.fillMaxWidth()) {
               ...
               AnimatedVisibility(
                   ...
                   enter = fadeIn() + expandVertically ( animationSpec =
...
fun ShowGalleryButton(galleryOpened : Boolean , onClick: () -> Unit){
  TextButton(onClick = onClick) {
      Text(text = if (galleryOpened) stringResource(id = R.string.HideGallery) else stringResource(
          id = R.string.ShowGallery
...
fun DiaryHolderPreview(){
    DiaryHolder(diary = Diary().apply {
        ...
        this.mood = Mood.Neutral.name
        this.title = "Hi"
        this.description = "this is just for test"
    }, onClick ={} )
}